  ...
  return (
    <div className='max-w-[1350px] mx-auto flex flex-wrap-reverse justify-center mt-16 items-center bg-black py-6'>
        <div className="basis-[45%] sm:text-center md:text-start">
            ...
            <Link to="/workout" style={{textDecoration:"none",color:"black"}}><button className='px-6 py-3 bg-[#fc3b00] text-black rounded-xl mr-4 my-2'>Get Started</button></Link>
            <Link to="/workout" style={{textDecoration:"none",color:"black"}}><button className='px-6 py-3 border border-[#fc3b00] text-[#fc3b00] rounded-xl mr-2 my-2'>How it Work</button></Link>
        </div>
